...
public class ServiceLogging {
	...
	@Around("execution(* com.jtudy.springaspect..*(..))" 
			+ "&& !execution(* com.jtudy.springaspect..*.get(..)) "
			+ "&& !@annotation(com.jtudy.springaspect.annotations.DontLog) "
            + "&& !@target(com.jtudy.springaspect.annotations.DontLog)"
			)			
